...
import {
  getLocalizedDashboardWidgetDescription,
  getLocalizedDashboardWidgetName,
...
export function DashboardWidget({
  ...
  const localizedWidgetName = getLocalizedDashboardWidgetName({
    owner: widget.data.owner,
    name: widget.data.name,
  });
  const localizedWidgetDescription = getLocalizedDashboardWidgetDescription({
    owner: widget.data.owner,
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="truncate font-medium" title={localizedWidgetName}>
          {localizedWidgetName}{" "}
      ...
      <div
        ...
        title={localizedWidgetDescription}
      >
        {localizedWidgetDescription}
      </div>
