...
const PAGE_MESSAGES: Record<string, string> = {
  "/project/[projectId]": "更高性能的仪表盘已可用。",
  "/project/[projectId]/dashboards": "更高性能的仪表盘已可用。",
  "/project/[projectId]/dashboards/[dashboardId]":
    "更高性能的仪表盘已可用。",
  "/project/[projectId]/traces": "更流畅的 Trace 界面已可用。",
  "/project/[projectId]/traces/[traceId]": "更流畅的 Trace 界面已可用。",
};
...
export function V4BetaPromoBanner() {
  ...
  return (
    <div
      ref={bannerRef}
      className="from-header via-background to-header/70 text-foreground fixed right-0 left-0 z-50 border-b bg-gradient-to-r shadow-sm backdrop-blur"
    ...
    >
      <div className="flex items-center gap-2 py-2 pl-3 pr-2">
        ...
        <p className="flex flex-1 flex-row gap-1 text-sm">
          <span className="font-semibold">{pageMessage}</span> 开启{" "}
          <button
