...
export function ScoreAnalyticsHeader({
  ...
  return (
    <div className="border-border mb-4 flex flex-col gap-2 rounded-3xl border border-sky-200/70 bg-white/85 p-3 shadow-sm backdrop-blur lg:flex-row lg:items-center lg:gap-4">
        ...
        <HoverCard>
          ...
          <HoverCardContent className="w-80">
            <div className="space-y-2">
              <h4 className="text-sm font-semibold">测试功能</h4>
              <p className="text-muted-foreground text-sm">
                评分分析目前处于测试阶段。我们正在持续优化这项能力，欢迎你提供反馈。
              </p>
              <a
