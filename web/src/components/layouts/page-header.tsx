...
const PageHeader = ({
  ...
  return (
    <div
      className={cn([
        "top-banner-offset sticky z-30 w-full border-b border-white/70 bg-linear-to-r from-[#eef5ff]/95 via-[#f5f9ff]/95 to-[#edf6ff]/95 shadow-[0_16px_34px_-26px_rgba(37,99,235,0.45)] backdrop-blur-md",
        className,
      ])}
      id="page-header"
    >
