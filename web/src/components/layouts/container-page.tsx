...
const ContainerPage = ({ children, headerProps }: SettingsContainerProps) => {
  return (
    <div
      className={cn(
        "min-h-screen-with-banner relative flex flex-1 flex-col bg-linear-to-br from-[#edf5ff] via-[#f7fbff] to-[#eef7ff]",
      )}
    >
      ...
      <main
        className={cn(
          "min-h-screen-with-banner relative flex flex-1 flex-col p-4",
