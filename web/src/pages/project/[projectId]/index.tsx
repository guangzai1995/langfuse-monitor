            ...
            <>
              {uiCustomization?.feedbackHref === undefined && (
                <FeedbackButtonWrapper
                  title="申请新图表"
                  description="如果你希望在仪表盘中看到更多指标或图表，可以直接把需求发给团队。"
                ...
                >
                  <Button
                    ...
                    variant={"outline"}
                    className={
                      "group justify-start gap-x-3 rounded-xl border-white/80 bg-white/85 text-left font-semibold text-slate-700 hover:bg-white hover:text-primary"
                    }
                  >
                    <BarChart2
                      className="hidden h-6 w-6 shrink-0 text-primary lg:block"
                      aria-hidden="true"
                    />
                    申请新图表
                  </Button>
